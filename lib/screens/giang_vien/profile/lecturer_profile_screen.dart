...
class _LecturerProfileScreenState extends State<LecturerProfileScreen> {
  ...
  Widget _buildProfileHeader(dynamic lecturer) {
    final initials = _getInitials(lecturer.fullName);
  ...
  Widget _buildInfoCard(dynamic lecturer) {
    return Card(
      child: Column(
        children: [
          ListTile(
            ...
            subtitle: Text(lecturer.fullName),
          ),
          ...
          ListTile(
            ...
            subtitle: Text(lecturer.lecturerCode),
          ),
          ...
          ListTile(
            ...
            onTap: () => _changeEmail(lecturer.email),
          ),
          ...
          ListTile(
            ...
            subtitle: Text(lecturer.faculty),
          ),
  ...
  Future<void> _verifyNewEmail(String newEmail) async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) {
        return AlertDialog(
          ...
          content: Text(
            '${AppLocalizations.text(
              'Bạn có muốn sử dụng email',
              en: 'Do you want to use the email',
            )} $newEmail?',
          ),
          actions: [
            TextButton(
    ...
    MockLecturer.updateEmail(newEmail);
